...
class CleanFID:
    ...
    """
    Function that takes an image (PIL.Image or np.array or torch.tensor)
    ...
    """
    Extract the features from x and add to the list of reference real images
    """
    ...
    """
    Extract the features from x and add to the list of generated images
    """
